...
class UserInfoAdmin(object):
    ...
    充电(微信)用户
    """
    list_display = ['name', 'nickname', 'openid', 'telephone', 'car_type', 'total_money', 'consume_money', 'account_balance', 'is_freeze', 'balance_reset']
    search_fields = ['name', 'openid', 'telephone', 'nickname', 'pile_sn', 'car_type']
...
class GiftMoneyRecordAdmin(object):
    """赠送金额记录表"""
    list_display = ('out_trade_no', 'name', 'openid', 'transaction_id', 'gift_amount', 'consume_amount', 'gift_time', 'status')
    list_per_page = 50
    search_fields = ['out_trade_no', 'name', 'openid', 'transaction_id']
    model_icon = 'fa fa-weixin'
