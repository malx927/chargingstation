...
class Order(models.Model):
    ...
    charg_mode = models.IntegerField(verbose_name='用户充电方式', choices=USER_CHARGING_MODE, blank=True, default=0)
...
class OrderChargDetail(models.Model):
    ...
    output_voltage = models.IntegerField(verbose_name='输出电压值', blank=True, null=True)
    output_current = models.IntegerField(verbose_name='所需电压值', blank=True, null=True)
