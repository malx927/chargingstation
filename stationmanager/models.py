...
class Station(models.Model):
    ...
    occupy_fee = models.DecimalField(verbose_name='占位费', max_digits=6, decimal_places=2, default=0.0, blank=True)
...
class ChargingPile(models.Model):
    ...
    station = models.ForeignKey(Station, verbose_name='所属充电站', on_delete=models.SET_NULL, blank=True, null=True)
